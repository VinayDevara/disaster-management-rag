    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400">Create your emergency response account</p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700/50 shadow-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Join the disaster management system
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignUp}>
              <div className="flex flex-col gap-6">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="repeat-password" className="text-gray-200">Confirm Password</Label>
                  <Input
                    id="repeat-password"
                    type="password"
                    required
        ...
        <p className="text-center text-xs text-gray-500 mt-8">
          Emergency management system. Secure registration required.
        </p>
      </div>
    </div>
  )
